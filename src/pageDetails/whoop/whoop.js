    ...
    <div className={styles.content}>
      ...
      <div className={styles.highlight}>
        ...
        <p>
          ...
          success managers to be able to view all their accounts and account
          stats in one centralized dashboard. For this feature I was the sole
          developer for both the front-end interface as well as the backend api
          endpoints.
        </p>
        <p>
          ...
          decisions on what attributes were needed to display the aggregated
          data shown on the designs. Then I implemented the SQL query to grab
          all relevant information from across various tables. After testing and
          ensuring the robustness of the endpoints, I implemented the front-end
          in React. The final product allowed CSM's to gain an overview of their
          accounts and aggregated data, greatly reducing the amount of time
          spent searching for information, and click into it to view more
          details about the members in each account.
        </p>
      ...
      <div className={styles.highlight}>
        ...
        <p>
          ...
          emails after uploading/inputting them. I was tasked with designing the
          review process for the invite flow as well as developing it. The
      ...
      <div className={styles.highlight}>
        ...
        <p>
          ...
          implement it in the front and back end. I collaborated with the designer to design the implemented
          page as well as future iterations of the page.
        </p>
      ...
      <div className={styles.highlight}>
        ...
        <p>
         I took on a side project in an effort to standardize how
          the web teams were styling applications. Throughout this project, I collabored with designers
          to come up and implement a typography design system which impacted all 3 web teams across the software department at Whoop. Read more about
          it here-
        </p>
      </div>
